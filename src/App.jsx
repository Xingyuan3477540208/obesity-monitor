    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="p-6">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">AUTO-UPDATING</span>
                </div>
          ...
          {activeTab === 'pipeline' && (
            <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Pipeline Comparison</h2>
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-4 border border-slate-200">
                <div className="flex flex-wrap gap-4 items-center">
                  ...
                  <select value={targetFilter} onChange={(e) => setTargetFilter(e.target.value)} className="px-3 py-1.5 border border-slate-300 rounded-lg text-sm bg-white">
                    ...
                    <option value="1">Single (GLP-1)</option>
                    <option value="2">Dual (GLP-1/GIP)</option>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-slate-200">
                      ...
                      <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Drug</th>
                      <th className="text-center py-3 px-4 text-sm font-semibold text-slate-700">Type</th>
                      <th className="text-center py-3 px-4 text-sm font-semibold text-slate-700">Targets</th>
                      <th className="text-center py-3 px-4 text-sm font-semibold text-slate-700">Weight Loss</th>
                      <th className="text-center py-3 px-4 text-sm font-semibold text-slate-700">Stage</th>
                      <th className="text-left py-3 px-4 text-sm font-semibold text-slate-700">Key Advantages</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl shadow-lg p-6 text-white">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold">FDA Decision: Orforglipron</h2>
                      <p className="text-orange-100">Eli Lilly's oral GLP-1</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-5xl font-bold">{daysUntilFDA}</div>
                    <div className="text-lg text-orange-100">days</div>
                  </div>
                </div>
              </div>

              <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
                <h2 className="text-xl font-bold text-slate-900 mb-4">Key Events 2026</h2>
