                  ...
                  <ResponsiveContainer width="100%" height={450}>
                    <AreaChart data={historicalData}>
                      ...
                      <Area type="monotone" dataKey="price" 
                            stroke={stock.change >= 0 ? "#10b981" : "#ef4444"} strokeWidth={3}
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-start gap-4">
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg transition-colors border border-blue-300 disabled:opacity-50"
                >
